mera1 = input('Введите исходные единицы измерения из списка доступных \
(аршин, шаг, верста, сажень, пядь:\n')
number = float(input('Введите число:\n'))
mera2 = input('Введите конечные единицы измерения из списка доступных \
(м, см):\n')
if mera2 == "см":
    if mera1 == "аршин":
